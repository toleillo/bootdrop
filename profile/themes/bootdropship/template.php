...
/*
function bootdropship_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/
/*
function bootdropship_preprocess_page(&$vars,$hook) {
  //typekit
...
*/
/*
function bootdropship_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function bootdropship_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function bootdropship_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function bootdropship_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function bootdropship_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function bootdropship_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/
/*
function bootdropship_form_alter(&$form, &$form_state, $form_id) {
  //if ($form_id == '') {
  //....
  //}
}
